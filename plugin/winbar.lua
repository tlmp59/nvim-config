...
-- source: https://github.com/echasnovski/mini.statusline/blob/main/lua/mini/statusline.lua
    ...
    callback = vim.schedule_wrap(function()
        ...
        for _, win_id in ipairs(vim.api.nvim_list_wins()) do
            ...
            if not vim.bo[buf_id].buflisted then
                ...
                vim.wo[win_id].winbar = (win_id == cur_win_id) and '%{%v:lua.status.active()%}' or '%{%v:lua.status.inactive()%}'
            end
        end
    end),
})
